...
class LanguageDetectorTest extends Specification {
    ...
    def "Detect languages"() {
        ...
        where:
            ...
            "fra"    | "Le petit chat dort tranquillement sur le canapé pendant que la pluie tombe doucement dehors."
            "deu"    | "Der schnelle braune Fuchs springt über den faulen Hund an einem späten Freitagnachmittag."
            ...
            "ron"    | "Vulpea maro rapidă sare peste câinele leneș într-o după-amiază liniștită de vineri. Este o zi frumoasă pentru a te plimba prin parc și a te bucura de natură."
            "nld"    | "De snelle bruine vos springt over de luie hond op een rustige vrijdagmiddag. Het was een prachtige dag om buiten te zijn en te genieten van het mooie weer."
            ...
            "ces"    | "Rychlá hnědá liška přeskočí líného psa pozdě v pátek odpoledne. Byl to nádherný den na procházku v parku a užívání si přírody."
            "slk"    | "Rýchla hnedá líška preskočí lenivého psa neskoro v piatok popoludní. Bol to nádherný deň na prechádzku v parku a užívanie si prírody."
            ...
            "hye"    | "Բացի բևեռացումից, որը բնութագրում է քիմիական կապը ստատիկ վիճակում, յուրաքանչյուր կապ կարող է օժտվել նաև բևեռայնությամբ, այսինքն՝ արտաքին էլեկտրամագնիսական դաշտի ազդեցության տակ բևեռացումը փոփոխելու հատկությամբ։"
            "zho"    | "小猫安静地睡在沙发上，外面的雨轻轻地下着。这是一个美丽的夜晚，适合在家里读一本好书。窗外的世界安静而祥和。"
